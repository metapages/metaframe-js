...
export const ButtonCopyExternalLink: React.FC = () => {
  ...
  const [metaframeInputs, setMetaframeInputs] = useState<InputsHashParam | undefined>(undefined);
  useEffect(() => {
  ...
  useEffect(() => {
    ...
    let newInputs: InputsHashParam | undefined = getHashParamValueJsonFromWindow<InputsHashParam | undefined>("inputs");
