...
export const EditDisableSmartInputUnpacking: React.FC = () => {
  ...
  const onSubmit = useCallback(
    (isChecked: boolean) => {
      setOption("disableSmartInputUnpacking", isChecked ? isChecked : undefined);
    },
    [setOption]
  );
  ...
  return (
    ...
    <FormControl pb="1rem" p={6}>
      ...
      <Text fontWeight={700} pb={2}>
        [Advanced] Disable smart input unpacking (auto-convert JSON binary <a href="https://developer.mozilla.org/en-US/docs/Web/API/Blob">Blobs</a> to objects)
      </Text>
      <Checkbox
